/* Copyright 2020 © Adobe Systems */
/*{"k":"1.4.0","auto_updating":true,"last_published":"2020-03-17 02:54:20 UTC"}*/
(function(config) {
	(function() {
		'use strict';
		var f, g = [];
				...
				if (a.a != p)
					for (; a.f.length;) {
						var b = a.f.shift(),
							...
							b = b[3];
						try {
							0 == a.a ? "function" == typeof c ? e(c.call(void 0, a.b)) : e(a.b) : 1 == a.a && ("function" == typeof d ?
								e(d.call(void 0, a.b)) : b(a.b))
						} catch (h) {
							b(h)
						}
					}
		...
		window.Promise || (window.Promise = n, window.Promise.resolve = u, window.Promise.reject = t, window.Promise.race =
			x, window.Promise.all = w, window.Promise.prototype.then = n.prototype.c, window.Promise.prototype["catch"] = n.prototype
			.g);
	}());
	...
	(function() {
		...
		function ba(a) {
			...
			for (var b = [], c = 0; c < a.length; c++) {
				var d = /^(u\+([0-9a-f?]{1,6})(?:-([0-9a-f]{1,6}))?)$/i.exec(a[c]),
					e;
				if (d)
					if (-1 !== d[2].indexOf("?") ? (e = parseInt(d[2].replace("?", "0"), 16), d = parseInt(d[2].replace("?", "f"),
							16)) : (e = parseInt(d[2], 16), d = d[3] ? parseInt(d[3], 16) : e), e !== d)
						for (; e <= d; e++) b.push(e);
					else b.push(e)
			}
			return b
		...
		function ha(a) {
			...
			do {
				var c = a.currentNode;
				if (c && "SCRIPT" !== c.nodeName && "STYLE" !== c.nodeName && "NOSCRIPT" !== c.nodeName && "TEMPLATE" !== c.nodeName &&
					"LINK" !== c.nodeName && "TITLE" !== c.nodeName) {
					for (var d = c.childNodes, e = 0; e < d.length; e++) d[e].nodeType !== Node.TEXT_NODE || /^\s*$/.test(d[e].nodeValue) ||
			...
			a = b.join("");
			b = new m;
			for (c = 0; c < a.length; c++) d = a.charCodeAt(c), 55296 === (d & 63488) && c < a.length ? (e = a.charCodeAt(c +
				1), 56320 === (e & 64512) ? b.b.push(((d & 1023) << 10) + (e & 1023) + 65536) : b.b.push(d), c++) : b.b.push(d);
			return r(b)
		};
		...
		function ka(a) {
			ja ? a.i.observe(a.b, {
				...
				subtree: !0,
				childList: !0
			}) : (a.b.addEventListener("DOMAttrModified", a.g.bind(a), !1), a.b.addEventListener("DOMNodeInserted", a.g.bind(
				a), !1), a.b.addEventListener("DOMCharacterDataModified", a.g.bind(a), !1))
		};
		...
		function E(a, b) {
			return a.b.replace(/\{([^\{\}]+)\}/g, function(a, d) {
				if ("?" == d.charAt(0)) {
					for (var c = d.slice(1).split(","), f = [], h = 0; h < c.length; h++) b[c[h]] && f.push(c[h] + "=" +
						encodeURIComponent(b[c[h]]));
		...
		Ba.prototype.load = function(a, b) {
			...
			return new Promise(function(a, b) {
				if (Ha() && !Ga()) {
					...
					function g() {
						var b;
						if (b = -1 != q && -1 != u || -1 != q && -1 != k || -1 != u && -1 != k)(b = q != u && q != k && u != k) ||
							(null === Ca && (b = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent), Ca = !!b &&
								(536 > parseInt(b[1], 10) || 536 === parseInt(b[1], 10) && 11 >= parseInt(b[2], 10))), b = Ca && (q ==
								t && u == t && k == t || q == da && u == da && k == da || q == ea && u == ea && k == ea)), b = !b;
		...
		function La(a) {
			for (var b = /\burl\((\'|\"|)([^\'\"]+?)\1\)( format\((\'|\"|)([^\'\"]+?)\4\))?/g, c, d = []; c = b.exec(a);) c[2] &&
				d.push({
					url: c[2],
					format: c[5]
				});
		...
		function Oa(a) {
			...
			return new Promise(function(c, d) {
				if (Na) {
					...
					e.send(null)
				} else e = new XDomainRequest, e.open("GET", a.replace(/^http(s)?:/i, window.location.protocol)), e.ontimeout =
					function() {
						return !0
		...
		I.prototype.add = function(a) {
			if (!this.has(a)) {
				...
				H.sheet.insertRule('@font-face{font-family:"' + a.family + '";font-style:' + a.style + ";font-weight:" + a.weight +
					";src:" + b + ";}", 0);
		...
		function Ra(a, b) {
			...
			return d ? a.fonts.filter(function(a) {
				for (var b = d.family, e = 0; e < b.length; e++)
					if (a.family === b[e] && a.style === d.style && a.stretch === d.stretch && c(a.weight) === c(d.weight)) return !
						0;
				return !1
			}) : null
		}
		...
		function Ta(a, b) {
			var c = b || 0,
				d, e, f = a.length % 4,
				h = a.length - f;
			for (e = 0; e < h; e += 4) d = (a.charCodeAt(e + 0) & 4294967295) << 0 | (a.charCodeAt(e + 1) & 4294967295) << 8 |
				(a.charCodeAt(e + 2) & 4294967295) << 16 | (a.charCodeAt(e + 3) & 4294967295) << 24, d = L(d, 3432918353), d = d <<
				15 | d >>> 17, d = L(d, 461845907), c ^= d, c = c << 13 | c >>> 19, c = L(c, 5) + 3864292196;
			d = 0;
			switch (f) {
				case 3:
		...
		var M = [2449897292, 4218179547, 2675077685, 1031960064, 1478620578, 1386343184, 3194259988, 2656050674, 3012733295,
			2193273665
		];
		Va.prototype.add = function(a) {
			if ("string" !== typeof a && "number" !== typeof a) throw Error("Value should be a string or number.");
			for (var b = "number" === typeof a, c = 0; c < this.g; c++) this.b.set(b ? Sa(a, M[c]) % this.size : Ta(a, M[c]) %
				this.size)
		};
		...
		function Wa(a) {
			...
			for (var b = "", c = 0; c < a.length; c++) var d = a[c],
				b = b + (String.fromCharCode((d & 4278190080) >>> 24) + String.fromCharCode((d & 16711680) >>> 16) + String.fromCharCode(
					(d & 65280) >>> 8) + String.fromCharCode((d & 255) >>> 0));
			a = b;
			b = "";
		...
		N.prototype.get = function(a) {
			...
			c = "";
			if (this.b)
				for (var d = new Uint8Array(this.b.buffer, this.b.byteOffset, this.b.byteLength), e = 0; e < d.byteLength; e++) d[
					e] && (c += String.fromCharCode(d[e]));
		...
		function eb(a) {
			if (null === a.g) {
				...
				for (var c = new Za, d = JSON.stringify(b), b = c.g.slice(0), c = c.b.slice(0), d = d + String.fromCharCode(128),
						e = Math.ceil((d.length / 4 + 2) / 16), f = Array(e), h = 0; h < e; h++) {
					f[h] = Array(16);
					for (var g = 0; 16 > g; g++) f[h][g] = d.charCodeAt(64 * h + 4 * g) << 24 | d.charCodeAt(64 * h + 4 * g + 1) <<
						16 | d.charCodeAt(64 * h + 4 * g + 2) << 8 | d.charCodeAt(64 * h + 4 * g + 3)
				}
				...
				for (var d = Array(64), l, k, t, ca, A, n, p, w, h = 0; h < e; h++) {
					...
					for (g = 16; 64 > g; g++) l = d[g - 15], k = d[g - 2], d[g] = (O(17, k) ^ O(19, k) ^ k >>> 10) + d[g - 7] + (O(7,
						l) ^ O(18, l) ^ l >>> 3) + d[g - 16] & 4294967295;
					l = c[0];
					k = c[1];
					t = c[2];
					ca = c[3];
		...
		function nb(a, b) {
			...
			for (e = 0; e < a.g.length; e++) {
				f = a.g[e];
				if (h = b.g[f] || null)
					for (1668112752 !== f && 1195661646 !== f && V(a.b[f], new DataView(d, a.i[e], U(a.m[e]))), a.b[f] = new DataView(
							d, a.i[e], U(a.m[e])), h = h.F, g = 0; g < h.length; g++) h[g].apply(a.b[f]);
			...
			for (e = 0; e < a.g.length; e++) f = a.g[e], g.setUint32(e * Y.u + 0, f), g.setUint32(e * Y.u + 4, c[e]), g.setUint32(
				e * Y.u + 8, a.i[e]), g.setUint32(e * Y.u + 12, a.m[e]);
		...
		pb.prototype.apply = function(a) {
			if (1 === this.type || 2 === this.type) V(this.b, new DataView(a.buffer, a.byteOffset + this.offset, this.b.byteLength));
				...
				for (var c = new R(this.b), e = ib(c, qb, this.b.byteLength / qb.u), b = 0; b < e.length; b++) c = new DataView(
						a.buffer, a.byteOffset + e[b].offset, e[b].D),
		...
		function xb(a, b) {
			return "url(" + E(a.url, b.get("l")) + ') format("woff2"),url(' + E(a.url, b.get("d")) + ') format("woff"),url(' +
				E(a.url, b.get("m")) + ') format("opentype")'
		}
						...
						if (b.b instanceof mb) {
							...
							return zb(b, c).then(function(d) {
								...
								if (0 === d.status) return nb(a, d), b.subset =
									c, b.b = a, b.w = new J(b.family, (new DataView(b.b.arrayBuffer)).buffer, yb(b)), b.w.load().then(
										function() {
											K.add(b.w);
											return b
										});
		...
		function Fb(a) {
			if (a.b && a.b.length) {
				for (var b = document.createElement("style"), c = "", d = 0; d < a.b.length; d += 2) c += a.b[d] +
					"{font-family:" + a.b[d + 1] + ";}";
				b.textContent = c;
		...
		window.Typekit.Font = function(a, b, c) {
			...
			b = config.preview.replace("{user}", encodeURIComponent(d)).replace("{font_alias}", encodeURIComponent(b)).replace(
				"{fvd}", encodeURIComponent(h)) + "&token=" + encodeURIComponent(e);
			return new wb(a, b, c)
		};
	}());
}({
	...
	"p": 1,
	"j": "1.4.0",
	"c": [".tk-myriad-pro-semi-condensed", "\"myriad-pro-semi-condensed\",sans-serif", ".tk-myriad-pro-condensed",
		"\"myriad-pro-condensed\",sans-serif", ".tk-myriad-pro", "\"myriad-pro\",sans-serif", ".tk-kozuka-mincho-pr6n",
		"\"kozuka-mincho-pr6n\",serif", ".tk-kozuka-gothic-pr6n", "\"kozuka-gothic-pr6n\",sans-serif",
		".tk-source-han-sans-japanese", "\"source-han-sans-japanese\",sans-serif", ".tk-a-otf-ud-shin-go-pr6n",
		"\"a-otf-ud-shin-go-pr6n\",sans-serif", ".tk-myriad-pro-semiextended", "\"myriad-pro-semiextended\",sans-serif",
		".tk-agenda", "\"agenda\",sans-serif", ".tk-agenda-condensed", "\"agenda-condensed\",sans-serif",
		".tk-agenda-extra-condensed", "\"agenda-extra-condensed\",sans-serif", ".tk-agenda-ultra-condensed",
		"\"agenda-ultra-condensed\",sans-serif", ".tk-whitman-display", "\"whitman-display\",serif",
		".tk-whitman-display-compressed", "\"whitman-display-compressed\",serif", ".tk-whitman-display-condensed",
		"\"whitman-display-condensed\",serif", ".tk-tbudmincho-std", "\"tbudmincho-std\",sans-serif"
	],
	"l": "typekit",
	"type": "dynamic",
	...
	"f": [{
		"source": "https://use.typekit.net/af/d44976/0000000000000000000170b3/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6801,
		"dynamic": false,
		"family": "myriad-pro-semi-condensed",
		"descriptors": {
			"weight": 700,
			"display": "auto",
		...
		"source": "https://use.typekit.net/af/69e254/0000000000000000000170ac/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6802,
		"dynamic": false,
		"family": "myriad-pro-semi-condensed",
		"descriptors": {
			...
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
			"subset": "7fa3915bdafdf03041871920a205bef951d72bf64dd4c4460fb992e3ecc3a862"
		}
	}, {
		"source": "https://use.typekit.net/af/a78021/0000000000000000000170ae/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6805,
		"dynamic": false,
		"family": "myriad-pro-semi-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/44bde1/0000000000000000000170b0/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6806,
		"dynamic": false,
		"family": "myriad-pro-semi-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/2efaa6/0000000000000000000170b4/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 9945,
		"dynamic": false,
		"family": "myriad-pro-semi-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/c63dde/0000000000000000000170a8/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6808,
		"dynamic": false,
		...
		"source": "https://use.typekit.net/af/f72c04/0000000000000000000170a4/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6809,
		"dynamic": false,
		"family": "myriad-pro-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/24a439/0000000000000000000170a9/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 8415,
		"dynamic": false,
		"family": "myriad-pro-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/af66cf/0000000000000000000170a5/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 8416,
		"dynamic": false,
		"family": "myriad-pro-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/1b1b1e/00000000000000000001709e/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6846,
		"dynamic": false,
		"family": "myriad-pro",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/2e2357/00000000000000000001709f/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6847,
		"dynamic": false,
		"family": "myriad-pro",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/d32e26/00000000000000000001709b/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6848,
		"dynamic": false,
		"family": "myriad-pro",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/cafa63/00000000000000000001709a/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 6851,
		"dynamic": false,
		"family": "myriad-pro",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/d3cd09/00000000000000003b9b367a/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21518,
		"dynamic": true,
		...
		"source": "https://use.typekit.net/af/44e013/00000000000000003b9b3676/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21519,
		"dynamic": true,
		"family": "kozuka-mincho-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/9de05b/00000000000000003b9b3677/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21521,
		"dynamic": true,
		"family": "kozuka-mincho-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/0a44a5/00000000000000003b9b3679/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21522,
		"dynamic": true,
		"family": "kozuka-mincho-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/3787ae/00000000000000003b9b3678/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21523,
		"dynamic": true,
		"family": "kozuka-mincho-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/da4d12/00000000000000003b9b3674/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21540,
		"dynamic": true,
		...
		"source": "https://use.typekit.net/af/9aee99/00000000000000003b9b3670/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21541,
		"dynamic": true,
		"family": "kozuka-gothic-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/ceb8b8/00000000000000003b9b3671/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21543,
		"dynamic": true,
		"family": "kozuka-gothic-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/92ac5d/00000000000000003b9b3673/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21544,
		"dynamic": true,
		"family": "kozuka-gothic-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/17f873/00000000000000003b9b3672/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 21545,
		"dynamic": true,
		"family": "kozuka-gothic-pr6n",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/a1b816/00000000000000003b9b36d9/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 23594,
		"dynamic": true,
		...
		"source": "https://use.typekit.net/af/8fb5c7/00000000000000003b9acbc5/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 26141,
		"dynamic": true,
		"family": "a-otf-ud-shin-go-pr6n",
		"descriptors": {
			"weight": 300,
			"display": "auto",
			"featureSettings": "\"ALL \"",
		...
		"source": "https://use.typekit.net/af/d6baab/00000000000000003b9ad2de/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 27069,
		"dynamic": false,
		"family": "myriad-pro-semiextended",
		"descriptors": {
			"style": "italic",
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
		...
		"source": "https://use.typekit.net/af/2b0ae7/00000000000000003b9ad2df/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 27070,
		"dynamic": false,
		"family": "myriad-pro-semiextended",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/25f703/00000000000000003b9ad2e2/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 27073,
		"dynamic": false,
		"family": "myriad-pro-semiextended",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/7f0b40/00000000000000003b9ad2e3/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 27074,
		"dynamic": false,
		"family": "myriad-pro-semiextended",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/2d6d3a/00000000000000003b9ae38e/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30023,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
			"weight": 100,
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A1-A3,U+A5-AC,U+AE-B0,U+B2-B4,U+B6-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
			"featureSettings": "\"ALL \"",
			"subset": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191"
		}
	}, {
		"source": "https://use.typekit.net/af/2439e4/00000000000000003b9ae391/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30026,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/0c0905/00000000000000003b9ae392/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30027,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/2dba1c/00000000000000003b9ae393/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30028,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/3ccb81/00000000000000003b9ae394/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30029,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/5be660/00000000000000003b9ae397/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30032,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/ab8655/00000000000000003b9ae398/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30033,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/b7c13e/00000000000000003b9ae399/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30034,
		"dynamic": false,
		"family": "agenda",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/e6d00e/00000000000000003b9ae3a0/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30041,
		"dynamic": false,
		"family": "agenda-condensed",
		"descriptors": {
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
			"featureSettings": "\"ALL \"",
		...
		"source": "https://use.typekit.net/af/c973f0/00000000000000003b9ae3a1/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30042,
		"dynamic": false,
		"family": "agenda-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/91ce6b/00000000000000003b9ae3a6/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30047,
		"dynamic": false,
		"family": "agenda-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/c186bf/00000000000000003b9ae3a7/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30048,
		"dynamic": false,
		"family": "agenda-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/4df97f/00000000000000003b9ae3ae/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30055,
		"dynamic": false,
		"family": "agenda-extra-condensed",
		"descriptors": {
			"style": "italic",
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A1-A3,U+A5-AC,U+AE-B0,U+B2-B4,U+B6-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
		...
		"source": "https://use.typekit.net/af/bed67f/00000000000000003b9ae3af/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30056,
		"dynamic": false,
		"family": "agenda-extra-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/b7a7d6/00000000000000003b9ae3b4/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30061,
		"dynamic": false,
		"family": "agenda-extra-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/a2c6c5/00000000000000003b9ae3b5/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30062,
		"dynamic": false,
		"family": "agenda-extra-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/9b1bf8/00000000000000003b9ae3bc/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30069,
		"dynamic": false,
		"family": "agenda-ultra-condensed",
		"descriptors": {
			"style": "italic",
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A1-A3,U+A5-AC,U+AE-B0,U+B2-B4,U+B6-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
		...
		"source": "https://use.typekit.net/af/29339e/00000000000000003b9ae3bd/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30070,
		"dynamic": false,
		"family": "agenda-ultra-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/d58a82/00000000000000003b9ae3c2/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30075,
		"dynamic": false,
		"family": "agenda-ultra-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/aba39b/00000000000000003b9ae3c3/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 30076,
		"dynamic": false,
		"family": "agenda-ultra-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/26bb0a/00000000000000003b9ae927/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31448,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
			"weight": 300,
			"display": "auto",
			"unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
		...
		"source": "https://use.typekit.net/af/ba6994/00000000000000003b9ae929/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31450,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/be39ee/00000000000000003b9ae92a/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31451,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/d8ddb9/00000000000000003b9ae92b/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31452,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/b44c5d/00000000000000003b9ae92d/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31454,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/4034e7/00000000000000003b9ae92f/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31456,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
			...
			"style": "italic",
			"display": "auto",
			"unicodeRange": "U+20-5D,U+5F-7E,U+A1-A3,U+A5-AB,U+AE-B0,U+B2-B4,U+B6-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
			"subset": "7fa3915bdafdf03041871920a205bef951d72bf64dd4c4460fb992e3ecc3a862"
		}
	}, {
		"source": "https://use.typekit.net/af/d047e3/00000000000000003b9ae930/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31457,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/573433/00000000000000003b9ae931/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31458,
		"dynamic": false,
		"family": "whitman-display",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/c6916e/00000000000000003b9ae936/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31463,
		"dynamic": false,
		"family": "whitman-display-compressed",
		"descriptors": {
			"display": "auto",
			"unicodeRange": "U+20-5D,U+5F-7E,U+A1-A3,U+A5-AB,U+AE-B0,U+B2-B4,U+B6-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
			"featureSettings": "\"ALL \"",
		...
		"source": "https://use.typekit.net/af/d353d4/00000000000000003b9ae939/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31466,
		"dynamic": false,
		"family": "whitman-display-compressed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/77cb18/00000000000000003b9ae93d/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31470,
		"dynamic": false,
		"family": "whitman-display-condensed",
		"descriptors": {
			"display": "auto",
			"unicodeRange": "U+20-5D,U+5F-7E,U+A1-A3,U+A5-AB,U+AE-B0,U+B2-B4,U+B6-FF,U+152-153,U+178,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122",
			"featureSettings": "\"ALL \"",
		...
		"source": "https://use.typekit.net/af/e4d30c/00000000000000003b9ae940/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 31473,
		"dynamic": false,
		"family": "whitman-display-condensed",
		"descriptors": {
		...
		"source": "https://use.typekit.net/af/08fe4c/00000000000000003b9b00fc/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 34830,
		"dynamic": true,
		"family": "tbudmincho-std",
		"descriptors": {
			"weight": 500,
			"display": "auto",
			"featureSettings": "\"ALL \"",
		...
		"source": "https://use.typekit.net/af/50214a/00000000000000003b9b00fe/27/{format}{?primer,unicode,gdyn,features,v}",
		"id": 34832,
		"dynamic": true,
		"family": "tbudmincho-std",
		"descriptors": {
